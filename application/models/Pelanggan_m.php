...
class Pelanggan_m extends CI_Model
{
    ...
    {
        $this->db->select('pelanggan.*, districts.name_districts as kecamatan, villages.name_villages as kelurahan, status.nama_status as ket');
        $this->db->from('pelanggan');
        $this->db->join('districts', 'id_districts = kec_pelanggan');
        $this->db->join('villages', 'id_villages = kel_pelanggan');
        $this->db->join('status', 'status.id = pelanggan.status_id');
    ...
    {
        $this->db->select('pelanggan. *, jenis.nama_jenis as jenis , provinces.name_provinces as provinsi , regencies.name_regencies as kabupaten , districts.name_districts as kecamatan, villages.name_villages as kelurahan, status.nama_status as ket');
        $this->db->from('pelanggan');
