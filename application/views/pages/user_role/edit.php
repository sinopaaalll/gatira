                    ...
                    <div class="section section-data-tables">
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <div class="card">
                                    <form action="<?= base_url('UserRole/update/' . $user_role['id']) ?>" method="post" autocomplete="off">
                                        <div class="card-content">
                                            <h4 class="card-title center-align">EDIT ROLE</h4>
                                                ...
                                                <div class="col s12 m6 offset-m3 l o8ffset-l2">
                                                    <div class="row margin">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="nama" type="text" name="nama" value="<?= $user_role['nama'] ?>">
