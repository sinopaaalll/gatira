                            ...
                            <div class="col s12">
                                ...
                                <div class="card">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($wilayah as $key => $row) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $row->cabang ?></td>
                                                                <td>
                                                                    <a href="<?= base_url('wilayah/edit/') . $row->kode_wilayah; ?>" class="btn-floating waves-effect waves-light btn-small yellow darken-4"><i class="material-icons" title="edit">edit</i></a>
                                                                    <a href="<?= base_url('wilayah/delete/') . $row->kode_wilayah; ?>" class="btn-floating waves-effect waves-light btn-small red btn-hapus " title="hapus"><i class="material-icons">delete</i></a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                    ...
                                    <div class="card-action">
                                        <!-- Modal Trigger -->
                                        <a href="<?= base_url('wilayah/create') ?>" class="btn blue darken-4"><i class="material-icons left">add</i>Tambah data</a>
