                    ...
                    <div class="section section-data-tables">
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <div class="card">
                                    <form action="<?= base_url('submenu/update/' . $submenu['id']) ?>" method="post" autocomplete="off">
                                        <div class="card-content">
                                            <h4 class="card-title center-align">EDIT SUBMENU</h4>
                                                ...
                                                <div class="col s12 m6 offset-m3 l8 offset-l2">
                                                            ...
                                                            <div class="select-wrapper">
                                                                <select name="menu" id="menu" class="browser-default">
                                                                    ...
                                                                    <?php foreach ($menu as $key => $value) { ?>
                                                                        <option <?= $value->id_menu == $submenu['menu_id'] ? "selected" : ""; ?> value="<?= $value->id_menu ?>"><?= $value->menu ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="row margin">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="title" type="text" name="title" placeholder="Contoh : Submenu Management" value="<?= $submenu['title'] ?>" autofocus>
                                                    ...
                                                    <div class="row margin">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="url" type="text" name="url" placeholder="Contoh : submenu/index" value="<?= $submenu['url'] ?>">
                                                    ...
                                                    <div class="row margin">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="icon" type="text" name="icon" placeholder="Contoh : insert_emoticon" value="<?= $submenu['icon'] ?>">
                                                    ...
                                                    <div class="row margin">
                                                        <div class="col s12">
                                                            ...
                                                            <p>
                                                                <label>
                                                                    <input class="validate" required="" name="is_active" value="1" type="radio" <?= $submenu['is_active'] == 1 ? 'checked=""' : "" ?>>
                                                                    <span>Aktif</span>
                                                                </label>
                                                            </p>

                                                            <label>
                                                                <input class="validate" required="" name="is_active" value="0" type="radio" <?= $submenu['is_active'] == 0 ? 'checked=""' : "" ?>>
                                        ...
                                        <div class="card-action">
                                            <a href="<?= base_url('submenu') ?>" class="btn yellow darken-4 modal-trigger"><i class="material-icons left">undo</i>Kembali</a>
