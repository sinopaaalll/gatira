                            ...
                            <div class="col s12">
                                ...
                                <div class="card">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($menu as $key => $row) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $row->menu ?></td>
                                                                <td>
                                                                    <a href="<?= base_url('menu/edit/') . $row->id_menu; ?>" class="btn-floating waves-effect waves-light btn-small yellow darken-4" title="edit"><i class="material-icons">edit</i></a>
                                                                    <a href="<?= base_url('menu/delete/') . $row->id_menu; ?>" class=" btn-floating waves-effect waves-light btn-small red btn-hapus " title="hapus"><i class="material-icons">delete</i></a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                    ...
                                    <div class="card-action">
                                        <!-- Modal Trigger -->
                                        <a href="<?= base_url('menu/create') ?>" class="btn blue darken-4"><i class="material-icons left">add</i>Tambah data</a>
                                    </div>
                                </div>
