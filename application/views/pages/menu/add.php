                    ...
                    <div class="section section-data-tables">
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <div class="card">
                                    <form action="<?= base_url('menu/create') ?>" method="post" autocomplete="off">
                                        <div class="card-content">
                                            <h4 class="card-title center-align">TAMBAH MENU</h4>
                                                ...
                                                <div class="col s12 m6 offset-m3 l8 offset-l2">
                                                    <div class="row margin">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="menu" type="text" name="menu" value="<?= set_value('menu') ?>" autofocus>
