                            ...
                            <div class="col s12">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title">Data Jenis Langganan</h4>
                                        <div class="row">
                                            <div class="col s12">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($jenis as $key => $row) : ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?= base_url('jenis/edit/') . $row->id; ?>" class="btn-floating waves-effect waves-light btn-small yellow darken-4" title="edit"><i class="material-icons">edit</i></a>
                                                                    <a href="<?= base_url('jenis/delete/') . $row->id; ?>" class=" btn-floating waves-effect waves-light btn-small red btn-hapus " title="hapus"><i class="material-icons">delete</i></a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                    ...
                                    <div class="card-action">
                                        <!-- Modal Trigger -->
                                        <a href="<?= base_url('jenis/create') ?>" class="btn blue darken-4"><i class="material-icons left">add</i>Tambah data</a>
                                    </div>
                                </div>
