                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Tambah Data Pengguna</span></h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item active">Tambah Data Pengguna
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <form action="<?= base_url('user/create') ?>" method="post" autocomplete="off">
                                        <div class="card-content">
                                            <h4 class="card-title center-align">TAMBAH DATA PENGGUNA</h4>
