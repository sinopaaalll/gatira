...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-dark-menu-template/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 May 2020 08:25:01 GMT -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('') ?>assets/css/pages/page-404.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
                ...
                <div class="section section-404 p-0 m-0 height-100vh">
                    <div class="row">
                        ...
                        <div class="col s12 center-align white">
                            <img src="<?= base_url('') ?>assets/images/gallery/error-2.png" class="bg-image-404" alt="">
                            <h1 class="error-code m-0">404</h1>
                            <h6 class="mb-2">BAD REQUEST</h6>
                            <a class="btn waves-effect waves-light blue darken-3 mb-4" href="<?= base_url('dashboard') ?>">Back
                                To Home</a>
                        </div>
                    </div>
                </div>
