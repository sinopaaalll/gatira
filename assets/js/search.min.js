...
$(function () {
	...
	if (
		...
		$(".search-button").click(function (e) {
			searchSm.is(":hidden")
				? (searchSm.show(), searchBoxSm.focus())
	...
	var a = $(
		".header-search-wrapper .header-search-input,.search-input-sm .search-box-sm"
	).data("search");
	$(".search-sm-close").on("click", function () {
		...
		$(
			...
			if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
				27 == e.keyCode &&
					(contentOverlay.removeClass("show"), s.val(""), s.blur());
				...
				if (($("ul.search-list li").remove(), "" != t)) {
					...
					$.getJSON("../../../app-assets/data/" + a + ".json", function (e) {
						for (var s = 0; s < e.listItems.length; s++)
							((0 == e.listItems[s].name.toLowerCase().indexOf(t) && n < 4) ||
					...
					contentOverlay.hasClass("show") &&
						(contentOverlay.removeClass("show"),
						searchList.addClass("display-none"));
			}
			$(".header-search-wrapper .current_item").length &&
				(searchList.scrollTop(0),
				searchList.scrollTop(
					$(".search-list .current_item:first").offset().top -
						searchList.height()
				)),
				$(".search-input-sm .current_item").length &&
					(searchListSm.scrollTop(0),
					searchListSm.scrollTop(
