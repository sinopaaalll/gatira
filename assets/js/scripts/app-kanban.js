$(document).ready(function () {
			...
			item: [
				{
					...
					comment: 1,
					attachment: 1,
					users: ["../../../assets/images/avatar/avatar-10.png"],
				},
				{
					id: "1_2",
				...
				},
				{
					...
					comment: 23,
					attachment: 1,
					users: ["../../../assets/images/avatar/avatar-11.png"],
				},
				{
					id: "1_4",
					...
					comment: 56,
					attachment: 1,
					users: ["../../../assets/images/avatar/avatar-12.png"],
				},
				{
					id: "1_5",
		...
		},
		{
			...
			item: [
				...
				},
				{
					...
					comment: 8,
					users: ["../../../assets/images/avatar/avatar-13.png"],
				},
				{
					id: "2_3",
			...
			item: [
				{
					...
					comment: 10,
					users: ["../../../assets/images/avatar/avatar-14.png"],
				},
				{
					id: "3_2",
				...
				},
				{
					...
					users: ["../../../assets/images/avatar/avatar-15.png"],
				},
			],
		},
	];
	...
	for (kanban_data in kanban_board_data) {
		...
		for (kanban_item in kanban_board_data[kanban_data].item) {
			...
			if (typeof $(board_item_el).attr("data-users") !== "undefined") {
				for (kanban_users in kanban_board_data[kanban_data].item[kanban_item]
					.users) {
					board_item_users +=
			...
			if (typeof $(board_item_el).attr("data-dueDate") !== "undefined") {
				board_item_dueDate =
					...
					$(board_item_el).attr("data-border") +
					'"><span class="' +
					$(board_item_el).attr("data-border") +
					'-text center"> ' +
	...
	kanban_board_data.map(function (obj) {
		$(".kanban-board[data-id='" + obj.id + "']")
			.find(".kanban-board-header")
			.addClass(obj.headerBg);
	});
	...
	addBoardDefault.addEventListener("click", function () {
		...
		if (kanbanNewBoard) {
			...
			kanbanNewBoardData =
				'<div class="dropdown">' +
				'<a class="dropdown-trigger" href="#" data-target="kan' +
				i +
	...
	for (var i = 1; i <= $(".kanban-board").length; i++) {
		$(".kanban-board[data-id='" + i + "']")
			.find(".kanban-board-header .dropdown-trigger")
			.attr("data-target", i);
		$(".kanban-board[data-id='" + i + "']")
			.find("ul")
			.attr("id", i);
